...
public class VentanaEntrenamiento2 extends JDialog {
	...
	public void inicializarComponentes() {
		...
		eTutorial4 = new JLabel("- Selecciona la cantidad de intentos que te gustaría tener");
		...
		eTutorial9 = new JLabel("- Para ingresar el número, dígita el número y oprime el candado.");
